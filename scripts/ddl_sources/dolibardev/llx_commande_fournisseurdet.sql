create table dolibardev.llx_commande_fournisseurdet
(
...
create index idx_commande_fournisseurdet_fk_commande
    on dolibardev.llx_commande_fournisseurdet (fk_commande);

create index idx_commande_fournisseurdet_fk_product
    on dolibardev.llx_commande_fournisseurdet (fk_product);
