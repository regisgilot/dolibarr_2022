create table dolibardev.llx_societe_account
(
...
create index idx_societe_account_fk_soc
    on dolibardev.llx_societe_account (fk_soc);

create index idx_societe_account_fk_website
    on dolibardev.llx_societe_account (fk_website);

create index idx_societe_account_login
    on dolibardev.llx_societe_account (login);

create index idx_societe_account_rowid
    on dolibardev.llx_societe_account (rowid);

create index idx_societe_account_status
    on dolibardev.llx_societe_account (status);
