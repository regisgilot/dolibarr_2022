create table dolibardev.llx_product_price
(
    ...
    multicurrency_price     double(24, 8) default 0.00000000          null,
...
create index idx_product_price_fk_product
    on dolibardev.llx_product_price (fk_product);

create index idx_product_price_fk_user_author
    on dolibardev.llx_product_price (fk_user_author);
