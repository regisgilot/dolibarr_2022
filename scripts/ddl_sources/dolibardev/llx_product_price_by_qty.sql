create table dolibardev.llx_product_price_by_qty
(
    ...
    constraint fk_product_price_by_qty_fk_product_price
        foreign key (fk_product_price) references dolibardev.llx_product_price (rowid)
)
    charset = latin1;

create index idx_product_price_by_qty_fk_product_price
    on dolibardev.llx_product_price_by_qty (fk_product_price);
