create table dolibardev.llx_commandedet
(
    ...
    constraint fk_commandedet_fk_commande
        foreign key (fk_commande) references dolibardev.llx_commande (rowid),
    constraint fk_commandedet_fk_commandefourndet
        foreign key (fk_commandefourndet) references dolibardev.llx_commande_fournisseurdet (rowid),
...
create index idx_commandedet_fk_commande
    on dolibardev.llx_commandedet (fk_commande);

create index idx_commandedet_fk_product
    on dolibardev.llx_commandedet (fk_product);
