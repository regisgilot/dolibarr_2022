create table dolibardev.llx_commande_fournisseur
(
    rowid                   int auto_increment
        primary key,
    ref                     varchar(255)                              not null,
    entity                  int           default 1                   not null,
    ref_ext                 varchar(64)                               null,
    ...
    fk_input_method         int           default 0                   null,
    ...
    constraint uk_commande_fournisseur_ref
        unique (ref, fk_soc, entity),
    constraint fk_commande_fournisseur_fk_soc
        foreign key (fk_soc) references dolibardev.llx_societe (rowid)
)
    charset = latin1;

create index billed
    on dolibardev.llx_commande_fournisseur (billed);

create index idx_commande_fournisseur_fk_soc
    on dolibardev.llx_commande_fournisseur (fk_soc);
