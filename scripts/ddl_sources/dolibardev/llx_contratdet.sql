create table dolibardev.llx_contratdet
(
    ...
    constraint fk_contratdet_fk_contrat
        foreign key (fk_contrat) references dolibardev.llx_contrat (rowid),
...
create index idx_contratdet_date_fin_validite
    on dolibardev.llx_contratdet (date_fin_validite);

create index idx_contratdet_date_ouverture
    on dolibardev.llx_contratdet (date_ouverture);

create index idx_contratdet_date_ouverture_prevue
    on dolibardev.llx_contratdet (date_ouverture_prevue);

create index idx_contratdet_fk_contrat
    on dolibardev.llx_contratdet (fk_contrat);

create index idx_contratdet_fk_product
    on dolibardev.llx_contratdet (fk_product);
