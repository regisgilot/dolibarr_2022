create table dolibardev.llx_categorie_actioncomm
(
    ...
    constraint fk_categorie_actioncomm_fk_actioncomm
        foreign key (fk_actioncomm) references dolibardev.llx_actioncomm (id)
);

create index idx_categorie_actioncomm_fk_actioncomm
    on dolibardev.llx_categorie_actioncomm (fk_actioncomm);

create index idx_categorie_actioncomm_fk_categorie
    on dolibardev.llx_categorie_actioncomm (fk_categorie);
