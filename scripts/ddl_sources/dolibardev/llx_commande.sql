create table dolibardev.llx_commande
(
...
create index idx_commande_fk_account
    on dolibardev.llx_commande (fk_account);

create index idx_commande_fk_currency
    on dolibardev.llx_commande (fk_currency);

create index idx_commande_fk_projet
    on dolibardev.llx_commande (fk_projet);

create index idx_commande_fk_soc
    on dolibardev.llx_commande (fk_soc);

create index idx_commande_fk_user_author
    on dolibardev.llx_commande (fk_user_author);

create index idx_commande_fk_user_cloture
    on dolibardev.llx_commande (fk_user_cloture);

create index idx_commande_fk_user_valid
    on dolibardev.llx_commande (fk_user_valid);
