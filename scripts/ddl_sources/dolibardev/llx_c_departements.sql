create table dolibardev.llx_c_departements
(
    ...
    constraint fk_departements_fk_region
        foreign key (fk_region) references dolibardev.llx_c_regions (code_region)
)
    charset = latin1;

create index idx_departements_fk_region
    on dolibardev.llx_c_departements (fk_region);
