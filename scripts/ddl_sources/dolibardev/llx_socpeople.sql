create table dolibardev.llx_socpeople
(
...
create index idx_socpeople_fk_soc
    on dolibardev.llx_socpeople (fk_soc);

create index idx_socpeople_fk_user_creat
    on dolibardev.llx_socpeople (fk_user_creat);

create index idx_socpeople_lastname
    on dolibardev.llx_socpeople (lastname);
