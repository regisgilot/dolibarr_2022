create table dolibardev.llx_paiementfourn_facturefourn
(
...
create index idx_paiementfourn_facturefourn_fk_facture
    on dolibardev.llx_paiementfourn_facturefourn (fk_facturefourn);

create index idx_paiementfourn_facturefourn_fk_paiement
    on dolibardev.llx_paiementfourn_facturefourn (fk_paiementfourn);
