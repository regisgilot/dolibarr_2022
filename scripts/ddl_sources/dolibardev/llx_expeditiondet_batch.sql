create table dolibardev.llx_expeditiondet_batch
(
    ...
    constraint fk_expeditiondet_batch_fk_expeditiondet
        foreign key (fk_expeditiondet) references dolibardev.llx_expeditiondet (rowid)
)
    charset = latin1;

create index idx_fk_expeditiondet
    on dolibardev.llx_expeditiondet_batch (fk_expeditiondet);
