create table dolibardev.llx_fichinter_rec
(
...
create index idx_fichinter_rec_fk_projet
    on dolibardev.llx_fichinter_rec (fk_projet);

create index idx_fichinter_rec_fk_soc
    on dolibardev.llx_fichinter_rec (fk_soc);

create index idx_fichinter_rec_fk_user_author
    on dolibardev.llx_fichinter_rec (fk_user_author);
