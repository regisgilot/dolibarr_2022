...
create index idx_product_barcode
    on llx_product_fournisseur_price (barcode);

create index idx_product_fk_barcode_type
    on llx_product_fournisseur_price (fk_barcode_type);

create index idx_product_fourn_price_fk_product
    on llx_product_fournisseur_price (fk_product, entity);

create index idx_product_fourn_price_fk_soc
    on llx_product_fournisseur_price (fk_soc, entity);

create index idx_product_fournisseur_price_fk_user
    on llx_product_fournisseur_price (fk_user);
